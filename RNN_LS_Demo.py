...
weight_0 = 2*np.random.random((input_dim,hidden_dim)) - 1  
weight_1 = 2*np.random.random((hidden_dim,output_dim)) - 1  
weight_h = 2*np.random.random((hidden_dim,hidden_dim)) - 1  
...
for j in range(1000000):  
    ...
    for position in range(binary_dim):  
        ...
        layer_1 = sigmoid(np.dot(X,weight_0) + np.dot(layer_1_values[-1],weight_h))  
